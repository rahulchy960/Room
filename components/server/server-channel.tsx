      ...
      {channel.name !== "General" && role !== MemberRole.GUEST && (
        <div className="ml-auto flex items-center gap-x-2">
          <ActionTooltip label="Edit" >
            <Edit className="hidden group-hover:block w-4 h-4 hover:text-primary-foreground transition duration-100" />
          </ActionTooltip>
          <ActionTooltip label="Delete" >
            <Trash className="hidden group-hover:block w-4 h-4 hover:text-destructive transition duration-100" />
          </ActionTooltip>
        </div>
      )}
